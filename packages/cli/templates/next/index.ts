...
export function createLandingPage(name: string): string {
  return `import { Card, Snippet } from "${name}/ui";
  ...
  return (
    <div className="min-h-screen text-black dark:text-white">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-[70px_1fr] p-4 text-black dark:text-white">
            ...
            <div className="pt-3">
              ...
              <div className="-mt-1 pl-1 text-xl  font-light text-black opacity-50 dark:!opacity-100">
      ...
      <div className="mx-auto mt-20 grid max-w-2xl grid-cols-2 gap-6">
        <Card href="https://github.com/grimm-integrations/turbo-plus" title="Turbo Plus Repo">
